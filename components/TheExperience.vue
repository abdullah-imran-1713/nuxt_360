...
import { GLTFLoader } from 'three/examples/jsm/loaders/GLTFLoader.js'; // Import GLTFLoader from three.js
import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls.js'; // Import OrbitControls from three.js
...
export default {
  ...
  setup(props) {
    ...
    // Computed property to get the car model path based on selectedCar prop
    const carModelPath = computed(() => {
      switch (props.selectedCar) {
        case 'BMW':
          return '/carr/scene.gltf';
        case 'Nissan':
          return '/nissan/scene.gltf';
        case 'Benz':
          return '/benz/scene.gltf';
        case 'Porsche':
          return '/porsche/scene.gltf';
        
        default:
          return '/default_car/scene.gltf';
      }
    });
    ...
    // Car model
    gltfLoader.load(carModelPath.value, (gltf) => {
      model = gltf.scene;
    ...
    <div>
      ...
      <div class="progress-bar-container">
       ...
       <!-- <button @click="switchToInteriorView">Interior</button> -->
        <!-- <BRButton /> -->
        <Sidebar @switch-to-interior="switchToInteriorView" @switch-to-basic="switchToBasic" />
    </div>
</template>
